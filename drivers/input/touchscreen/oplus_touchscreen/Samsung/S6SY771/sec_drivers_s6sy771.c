...
static inline int sec_enable_black_gesture(struct chip_data_s6sy771 *chip_info, bool enable)
{
    int ret = 0;
    int i = 0;
...
static inline int sec_send_charge_state(struct chip_data_s6sy771 *chip_info)
{
    int ret = -1;
    u8 data = 1;
...
static inline int sec_enable_charge_mode(struct chip_data_s6sy771 *chip_info, bool enable)
{
    int ret = -1;
...
static inline int sec_enable_wireless_charge_mode(struct chip_data_s6sy771 *chip_info, bool enable)
{
    int ret = -1;
...
static inline int sec_enable_earsense_mode(struct chip_data_s6sy771 *chip_info, bool enable)
{
    int ret = -1;
...
static inline int sec_enable_palm_reject(struct chip_data_s6sy771 *chip_info, bool enable)
{
    int ret = -1;
...
static inline int sec_enable_game_mode(struct chip_data_s6sy771 *chip_info, bool enable)
{
    int ret = -1;
...
static inline int sec_enable_headset_mode(struct chip_data_s6sy771 *chip_info, bool enable)
{
    int ret = -1;
...
inline void sec_mdelay(unsigned int ms)
{
    if (ms < 20)
...
inline int sec_wait_for_ready(struct chip_data_s6sy771 *chip_info, unsigned int ack)
{
    int rc = -1;
...
static inline int sec_enter_fw_mode(struct chip_data_s6sy771 *chip_info)
{
    int ret = -1;
    u8 device_id[3] = {0};
...
static inline int sec_flash_page_erase(struct chip_data_s6sy771 *chip_info, u32 page_idx, u32 page_num)
{
    int ret = -1;
    u8 tCmd[6] = {0};
...
static inline int sec_flash_page_write(struct chip_data_s6sy771 *chip_info, u32 page_idx, u8 *page_data)
{
    int ret;
...
static inline bool sec_limited_flash_page_write(struct chip_data_s6sy771 *chip_info, u32 page_idx, u8 *page_data)
{
    int ret = -1;
    u8 *tCmd = NULL;
...
static inline int sec_flash_write(struct chip_data_s6sy771 *chip_info, u32 mem_addr, u8 *mem_data, u32 mem_size)
{
    int ret = -1;
...
static inline int sec_block_read(struct chip_data_s6sy771 *chip_info, u32 mem_addr, int mem_size, u8 *buf)
{
    int ret;
    u8 cmd[5];
    u8 *data;
...
static inline int sec_memory_read(struct chip_data_s6sy771 *chip_info, u32 mem_addr, u8 *mem_data, u32 mem_size)
{
    int ret;
    int retry = 3;
    int read_size = 0;
...
static inline int sec_chunk_update(struct chip_data_s6sy771 *chip_info, u32 addr, u32 size, u8 *data)
{
    int ii = 0, ret = 0;
    u8 *mem_rb = NULL;
    u32 write_size = 0;
...
static inline int sec_read_calibration_report(struct chip_data_s6sy771 *chip_info)
{
    int ret;
    u8 buf[5] = { 0 };
...
static inline int sec_execute_force_calibration(struct chip_data_s6sy771 *chip_info)
{
    int rc = -1;
...
static inline bool check_calibration(struct chip_data_s6sy771 *chip_info)
{
    u8 *data = NULL;
...
static inline int sec_fix_tmode(struct chip_data_s6sy771 *chip_info, u8 mode, u8 state)
{
    int ret = -1;
...
static inline int sec_release_tmode(struct chip_data_s6sy771 *chip_info)
{
    int ret = -1;
...
static inline int sec_read_self(struct chip_data_s6sy771 *chip_info, u8 type, char *data, int len)
{
    int ret = 0;
...
static inline int sec_read_mutual(struct chip_data_s6sy771 *chip_info, u8 type, char *data, int len)
{
    int ret = 0;
    //u8 buf[2] = {0};
    unsigned int data_len = (chip_info->hw_res->TX_NUM * chip_info->hw_res->RX_NUM) * 2;
...
static inline void sec_rtdp_start(struct chip_data_s6sy771 *chip_info)
{
    int ret = -1;
...
static inline int sec_rtdp_read_event(struct chip_data_s6sy771 *chip_info)
{
    int ret = -1;
...
static inline void sec_rtdp_dump(struct seq_file *s, struct chip_data_s6sy771 *chip_info)
{
    uint8_t temp[2] = {0};
    uint8_t *pRead = NULL;
    int16_t nodeData = 0;
...
static inline void sec_earsese_rawdata_read(void *chip_data, char *rawdata, int read_len)
{
    int ret = 0;
    u8 buf[2] = {0};
    int i = 0, j = 0;
...
static inline void sec_earsese_delta_read(void *chip_data, char *earsense_delta, int read_len)
{
...
static inline void sec_earsese_selfdata_read( void *chip_data, char *self_data, int read_len)
{
    int i = 0, ret = 0;
    int8_t tmp = 0;
    struct chip_data_s6sy771 *chip_info = (struct chip_data_s6sy771 *)chip_data;
...
static inline int sec_execute_selftest(struct seq_file *s, int fd, struct chip_data_s6sy771 *chip_info, struct sec_testdata *sec_testdata)
{
    int rc = -1;
...
static inline int sec_execute_p2ptest(struct seq_file *s, struct chip_data_s6sy771 *chip_info, struct sec_testdata *sec_testdata)
{
    int rc;
...
static inline int sec_get_verify_result(struct chip_data_s6sy771 *chip_info)
{
    int ret = -1;
