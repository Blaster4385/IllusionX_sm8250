...
#define DEF_GC_BALANCE_MIN_SLEEP_TIME   10000
#define DEF_GC_FRAG_MIN_SLEEP_TIME      1000
#define GC_URGENT_CHECK_TIME    (10*60*1000)
#define GC_URGENT_DISABLE_BLOCKS        (16<<18)
#define GC_URGENT_DISABLE_FREE_BLOCKS	(10<<18)
