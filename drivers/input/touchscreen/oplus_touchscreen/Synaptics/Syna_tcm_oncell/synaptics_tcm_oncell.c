 ...
 */
static inline int syna_get_report_data(struct syna_tcm_data *tcm_info, unsigned int offset,
 ...
 */
static inline int syna_parse_report(struct syna_tcm_data *tcm_info)
{
    int i = 0;
    int retval = 0;
...
static inline int syna_get_input_params(struct syna_tcm_data *tcm_info)
{
    int retval;
...
static inline int syna_set_default_report_config(struct syna_tcm_data *tcm_info)
{
    int retval = 0;
    int length = 0;
...
static inline int syna_get_default_report_config(struct syna_tcm_data *tcm_info)
{
    int retval = 0;
    unsigned int length;
...
static inline int syna_set_normal_report_config(struct syna_tcm_data *tcm_info)
{
    int retval;
    unsigned int idx = 0;
    unsigned int length;
...
static inline int syna_set_gesture_report_config(struct syna_tcm_data *tcm_info)
{
    int retval;
    unsigned int idx = 0;
    unsigned int length;
...
inline int syna_set_input_reporting(struct syna_tcm_data *tcm_info, bool suspend)
{
    int retval = 0;
    struct touch_hcd *touch_hcd = tcm_info->touch_hcd;
...
static inline void syna_set_trigger_reason(struct syna_tcm_data *tcm_info, irq_reason trigger_reason)
{
...
static inline void syna_tcm_resize_chunk_size(struct syna_tcm_data *tcm_info)
{
 ...
 * report occurrence.
 */
static inline void syna_tcm_dispatch_report(struct syna_tcm_data *tcm_info)
{
    int ret = 0;
    struct touch_hcd *touch_hcd = tcm_info->touch_hcd;
 ...
 */
static inline void syna_tcm_dispatch_response(struct syna_tcm_data *tcm_info)
{
    int retval = 0;
 ...
 */
static inline void syna_tcm_dispatch_message(struct syna_tcm_data *tcm_info)
{
    int retval;
 ...
 */
static inline int syna_tcm_continued_read(struct syna_tcm_data *tcm_info)
{
    int retval = 0;
 ...
 */
static inline int syna_tcm_raw_read(struct syna_tcm_data *tcm_info, unsigned char *in_buf, unsigned int length)
{
    int retval = 0;
 ...
 */
static inline int syna_tcm_raw_write(struct syna_tcm_data *tcm_info, unsigned char command,
                              unsigned char *data, unsigned int length)
{
    int retval = 0;
 ...
 */
static inline int syna_tcm_read_message(struct syna_tcm_data *tcm_info, unsigned char *in_buf, unsigned int length)
{
    int retval = 0;
 ...
 */
static inline int syna_tcm_write_message(struct syna_tcm_data *tcm_info,
                                  unsigned char command, unsigned char *payload,
                                  unsigned int length, unsigned char **resp_buf,
                                  unsigned int *resp_buf_size, unsigned int *resp_length,
...
static inline int syna_tcm_get_app_info(struct syna_tcm_data *tcm_info)
{
    int retval = 0;
...
static inline int syna_tcm_get_boot_info(struct syna_tcm_data *tcm_info)
{
    int retval = 0;
    unsigned char *resp_buf = NULL;
    unsigned int resp_buf_size = 0, resp_length = 0;
...
static inline int syna_tcm_identify(struct syna_tcm_data *tcm_info, bool id)
{
    int retval;
...
static inline int syna_tcm_run_application_firmware(struct syna_tcm_data *tcm_info)
{
    int retval = 0;
    bool retry = true;
    unsigned char *resp_buf = NULL;
...
static inline int syna_tcm_run_bootloader_firmware(struct syna_tcm_data *tcm_info)
{
    int retval = 0;
    unsigned char *resp_buf = NULL;
    unsigned int resp_buf_size = 0, resp_length = 0;
...
static inline int syna_tcm_switch_mode(struct syna_tcm_data *tcm_info, enum firmware_mode mode)
{
    int retval = 0;
...
static inline int syna_tcm_get_dynamic_config(struct syna_tcm_data *tcm_info,
...
static inline int syna_tcm_set_dynamic_config(struct syna_tcm_data *tcm_info,
                                       enum dynamic_config_id id, unsigned short value)
{
    int retval = 0;
...
static inline int syna_tcm_sleep(struct syna_tcm_data *tcm_info, bool en)
{
    int retval = 0;
    unsigned char *resp_buf = NULL;
    unsigned int resp_buf_size = 0, resp_length = 0;
...
static inline int syna_report_refresh_switch(void *chip_data, int fps)
{
	int retval = 0;
...
static inline void syna_rate_white_list_ctrl(void *chip_data, int value)
{
	struct syna_tcm_data *tcm_info = (struct syna_tcm_data *)chip_data;
	unsigned short send_value = 1;
	int retval = 0;
...
static inline int syna_tcm_reset(void *chip_data)
{
    int retval = 0;
    unsigned char *resp_buf = NULL;
...
static inline int syna_get_chip_info(void *chip_data)
{
    int ret = 0;
    struct syna_tcm_data *tcm_info = (struct syna_tcm_data *)chip_data;
...
static inline int syna_get_vendor(void *chip_data, struct panel_info *panel_data)
{
...
static inline u32 syna_trigger_reason(void *chip_data, int gesture_enable, int is_suspended)
{
    struct syna_tcm_data *tcm_info = (struct syna_tcm_data *)chip_data;
...
static inline int syna_get_touch_points(void *chip_data, struct point_info *points, int max_num)
{
...
static inline int syna_get_touch_points_auto(void *chip_data,
...
static inline int syna_tcm_set_gesture_mode(struct syna_tcm_data *tcm_info, bool enable)
{
    int retval = 0;
...
static inline void syna_tcm_enable_gesture_mask(void *chip_data, uint32_t enable)
{
    int retval = 0;
    struct syna_tcm_data *tcm_info = (struct syna_tcm_data *)chip_data;
...
static inline int syna_tcm_set_game_mode(struct syna_tcm_data *tcm_info, bool enable)
{
    int retval = 0;
...
static inline int syna_tcm_normal_mode(struct syna_tcm_data *tcm_info)
{
    int retval;
...
static inline int syna_corner_limit_handle(struct syna_tcm_data *tcm_info)
{
    int ret = -1;
...
static inline int syna_enable_edge_limit(struct syna_tcm_data *tcm_info)
{
    int ret = 0;
    TPD_INFO("%s: enter\n", __func__);
...
static inline int syna_mode_switch(void *chip_data, work_mode mode, bool flag)
{
    int ret = 0;
    struct syna_tcm_data *tcm_info = (struct syna_tcm_data *)chip_data;
...
static inline int syna_ftm_process(void *chip_data)
{
...
static inline int syna_tcm_reinit_device(void *chip_data)
{
...
static inline int syna_power_control(void *chip_data, bool enable)
{
    int ret = 0;
    struct syna_tcm_data *tcm_info = (struct syna_tcm_data *)chip_data;
...
static inline fw_check_state syna_fw_check(void *chip_data, struct resolution_info *resolution_info, struct panel_info *panel_data)
{
    struct syna_tcm_data *tcm_info = (struct syna_tcm_data *)chip_data;
    u16 config = 0;
    int retval = 0;
...
static inline int syna_tcm_helper(struct syna_tcm_data *tcm_info)
{
...
static inline void syna_tcm_helper_work(struct work_struct *work)
{
    int retval = 0;
...
static inline int syna_tcm_async_work(void *chip_data)
{
    int retval = 0;
    struct syna_tcm_data *tcm_info = (struct syna_tcm_data *)chip_data;
...
static inline int syna_tcm_enable_report(struct syna_tcm_data *tcm_info, enum report_type report_type, bool enable)
{
    int retval;
...
static inline void syna_tcm_enable_fingerprint(void *chip_data, uint32_t enable)
{
    int retval = 0;
    struct syna_tcm_data *tcm_info = (struct syna_tcm_data *)chip_data;
    TPD_INFO("%s: enable(%d)\n", __func__, enable);
...
static inline void syna_tcm_fingerprint_info(void *chip_data, struct fp_underscreen_info *fp_tpinfo)
{
    struct syna_tcm_data *tcm_info = (struct syna_tcm_data *)chip_data;
    struct touch_hcd *touch_hcd = tcm_info->touch_hcd;
    struct touch_data *touch_data = &touch_hcd->touch_data;
...
static inline void syna_tcm_fingerprint_info_auto(void *chip_data,
...
static inline void syna_tcm_get_health_info(void *chip_data, struct monitor_data *mon_data)
{
    struct syna_tcm_data *tcm_info = (struct syna_tcm_data *)chip_data;
...
static inline int syna_tcm_erase_flash(struct syna_tcm_data *tcm_info, unsigned int page_start, unsigned int page_count)
{
    int ret = 0;
...
static inline int syna_tcm_write_flash(struct syna_tcm_data *tcm_info, struct reflash_hcd *reflash_hcd,
...
static inline fw_update_state syna_tcm_fw_update(void *chip_data, const struct firmware *fw, bool force)
{
    int ret = 0;
    struct syna_tcm_data *tcm_info = (struct syna_tcm_data *)chip_data;
...
static inline void syna_tcm_fw_update_in_bl(void)
{
	int ret = -1;
...
static inline int syna_get_gesture_info(void *chip_data, struct gesture_info *gesture)
{
    struct syna_tcm_data *tcm_info = (struct syna_tcm_data *)chip_data;
    struct touch_hcd *touch_hcd = tcm_info->touch_hcd;
    struct touch_data *touch_data = &touch_hcd->touch_data;
...
static inline int syna_get_gesture_info_auto(void *chip_data,
...
inline int syna_tcm_get_frame_size_words(struct syna_tcm_data *tcm_info, bool image_only)
{
    unsigned int rows;
    unsigned int cols;
    unsigned int hybrid;
...
static inline int testing_run_prod_test_item(struct syna_tcm_data *tcm_info, enum test_item_bit test_code)
{
    int retval = 0;
    struct syna_tcm_test *test_hcd = tcm_info->test_hcd;
...
static inline int syna_int_pin_test(struct seq_file *s, struct syna_tcm_data *tcm_info,
...
static inline int syna_trx_short_test(struct seq_file *s, struct syna_tcm_data *tcm_info,
                               struct syna_testdata *syna_testdata, int item_offset, int error_count)
{
    uint8_t u_data8 = 0;
    int i = 0, j = 0, ret = 0;
...
static inline int syna_trx_open_test(struct seq_file *s, struct syna_tcm_data *tcm_info,
                              struct syna_testdata *syna_testdata, int item_offset, int error_count)
{
    uint8_t u_data8 = 0;
    int i = 0, j = 0, ret = 0;
...
static inline int syna_trx_gndshort_test(struct seq_file *s, struct syna_tcm_data *tcm_info,
                                  struct syna_testdata *syna_testdata, int item_offset, int error_count)
{
    uint8_t u_data8 = 0;
    int i = 0, j = 0, ret = 0;
...
static inline int syna_full_rawcap_test(struct seq_file *s, struct syna_tcm_data *tcm_info,
                                 struct syna_testdata *syna_testdata, int item_offset, int error_count)
{
    uint16_t u_data16 = 0;
...
static inline int syna_delta_noise_test(struct seq_file *s, struct syna_tcm_data *tcm_info,
                                 struct syna_testdata *syna_testdata, int item_offset, int error_count)
{
    int16_t data16 = 0;
    int i = 0, ret = 0, index = 0, byte_cnt = 2;
...
static inline int syna_hybrid_rawcap_test(struct seq_file *s, struct syna_tcm_data *tcm_info,
                                   struct syna_testdata *syna_testdata, int item_offset, int error_count)
{
    int32_t data32 = 0;
...
static inline int syna_hybrid_rawcap_test_ad(struct seq_file *s, struct syna_tcm_data *tcm_info,
                                   struct syna_testdata *syna_testdata, int item_offset, int error_count)
{
	int32_t data32 = 0;
	int i = 0, ret = 0, index = 0, byte_cnt = 2;
...
static inline int syna_rawcap_test(struct seq_file *s, struct syna_tcm_data *tcm_info,
                            struct syna_testdata *syna_testdata, int item_offset, int error_count)
{
    int16_t data16 = 0;
    int i = 0, ret = 0, index = 0, byte_cnt = 2;
...
static inline int syna_trex_shortcustom_test(struct seq_file *s, struct syna_tcm_data *tcm_info,
                                      struct syna_testdata *syna_testdata, int item_offset, int error_count)
{
    uint16_t u_data16 = 0;
    int i = 0, ret = 0, index = 0, byte_cnt = 2;
...
static inline int syna_hybrid_diffcbc_test(struct seq_file *s, struct syna_tcm_data *tcm_info,
                                    struct syna_testdata *syna_testdata, int item_offset, int error_count)
{
    uint16_t u_data16 = 0;
    int i = 0, ret = 0, index = 0, byte_cnt = 2;
...
static inline int syna_hybrid_absnoise_test(struct seq_file *s, struct syna_tcm_data *tcm_info,
                                     struct syna_testdata *syna_testdata, int item_offset, int error_count)
{
    int16_t data16 = 0;
    int i = 0, ret = 0, index = 0, byte_cnt = 2;
...
static inline void syna_auto_test(struct seq_file *s, void *chip_data, struct syna_testdata *syna_testdata)
{
...
static inline int syna_tcm_collect_reports(struct syna_tcm_data *tcm_info, enum report_type report_type, unsigned int num_of_reports)
{
    int retval;
...
static inline void syna_tcm_test_report(struct syna_tcm_data *tcm_info)
{
    int retval;
...
static inline void syna_tcm_format_print(struct seq_file *s, struct syna_tcm_data *tcm_info, char *buffer)
{
...
static inline void syna_tcm_format_unsigned_print(struct seq_file *s, struct syna_tcm_data *tcm_info, char *buffer)
{
    unsigned int row, col;
    unsigned int rows, cols;
    unsigned int cnt = 0;
...
static inline void syna_main_register(struct seq_file *s, void *chip_data)
{
    int retval = 0;
...
static inline void syna_delta_read(struct seq_file *s, void *chip_data)
{
    int retval;
    struct syna_tcm_data *tcm_info = (struct syna_tcm_data *)chip_data;
...
static inline void syna_baseline_read(struct seq_file *s, void *chip_data)
{
    int retval;
    struct syna_tcm_data *tcm_info = (struct syna_tcm_data *)chip_data;
...
inline void syna_reserve_read(struct seq_file *s, void *chip_data)
{
    int retval;
    struct syna_tcm_data *tcm_info = (struct syna_tcm_data *)chip_data;
...
static inline int syna_device_report_touch(struct syna_tcm_data *tcm_info)
{
...
static inline int syna_tcm_irq_handle(void *chip_data)
{
    struct syna_tcm_data *tcm_info = (struct syna_tcm_data *)chip_data;
...
static inline void syna_set_touch_direction(void *chip_data, uint8_t dir)
{
    struct syna_tcm_data *tcm_info = (struct syna_tcm_data *)chip_data;
...
static inline uint8_t syna_get_touch_direction(void *chip_data)
{
    struct syna_tcm_data *tcm_info = (struct syna_tcm_data *)chip_data;
...
static inline void syna_freq_hop_trigger(void *chip_data)
{
...
static inline int syna_tcm_smooth_lv_set(void *chip_data, int level)
{
    struct syna_tcm_data *tcm_info = (struct syna_tcm_data *)chip_data;
    unsigned short regval = 0;
    int retval = 0;
...
static inline int syna_tcm_sensitive_lv_set(void *chip_data, int level)
{
    struct syna_tcm_data *tcm_info = (struct syna_tcm_data *)chip_data;
    unsigned short regval = 0;
    int retval = 0;
...
static inline int syna_tcm_set_high_frame_rate(void *chip_data, int level, int time)
{
    struct syna_tcm_data *tcm_info = (struct syna_tcm_data *)chip_data;
    unsigned short regval = 0;
    int retval = 0;
...
static inline void syna_s3908_set_gesture_state(void *chip_data, int state)
{
	struct syna_tcm_data *tcm_info = (struct syna_tcm_data *)chip_data;
...
static inline int syna_tcm_send_temperature(void *chip_data, int temp, bool status)
{
	struct syna_tcm_data *tcm_info = (struct syna_tcm_data *)chip_data;
	unsigned short regval = 0;
	int retval = 0;
...
static inline void init_chip_dts(struct device *dev, void *chip_data)
{
	int rc;
	int ret = 0;
	int i = 0;
...
static inline int syna_tcm_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
    int retval = 0;
	u64 time_counter = 0;
    struct syna_tcm_data *tcm_info = NULL;
...
static inline int syna_tcm_remove(struct i2c_client *client)
{
...
static inline int syna_i2c_suspend(struct device *dev)
{
...
static inline int syna_i2c_resume(struct device *dev)
{
    struct touchpanel_data *ts = dev_get_drvdata(dev);
...
static inline int __init syna_tcm_module_init(void)
{
    TPD_INFO("%s is called\n", __func__);
...
static inline void __exit syna_tcm_module_exit(void)
{
